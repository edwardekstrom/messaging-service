...
//	newMessage = make_pair("new", "message");
//	vector<pair<string, string> > vectorOfPairs;
//	vectorOfPairs.push_back(newMessage);
//	messageMap["eddy"] = vectorOfPairs;

	for(int i = 0; i < 10; i++){

		Worker * w = new Worker(buflen_, &clientQueue, &messageMap);
		pthread_t thr;
...
//    	sem_wait(&clientQueue.e);
//    	sem_wait(&clientQueue.s);
//    	clientQueue.theQueue.push(client);
//    	cout << "push" << endl;
//    	sem_post(&clientQueue.s);
//    	sem_post(&clientQueue.n);
...
//
//string
//Server::parse_request(string req){
...
//
//string
//Server::parse_reset(string getString){
//	messageMap.clear();
//	return "OK\n";
//}
//
//string
//Server::parse_get(string getString){
...
//
//string
//Server::parse_put(string putString){
//	string line;
...
//
//string
//Server::parse_list(string listString){
...
//
//string
//Server::check_whole(string reqSoFar, int client){
//	string toReturn;
//	toReturn += reqSoFar;
//	try {
...
//
//string
//Server::wordAt(int index, string line)
//{
